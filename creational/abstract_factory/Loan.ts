...
export class MortgageLoan extends Loan {
    ...
    constructor (loanId: string, amount: number, income: number, installments: number) {  
        ...
        if((0.25 * income) < amount / installments) throw new Error("The installment amount could not exceed 25% of monthly income")
    }
...
export class CarLoan extends Loan {
    ...
    constructor (loanId: string, amount: number, income: number, installments: number) {  
        ...
        if((0.3 * income) < amount / installments) throw new Error("The installment amount could not exceed 30% of monthly income")
    }
